  ...
  return (
    <div className="container py-12 md:py-20">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {rooms.map((room) => (
          <article key={room.name} className="studio-card relative overflow-hidden rounded-lg border border-neutral-400/40 bg-card p-8 shadow-[0_8px_24px_rgba(0,0,0,0.22)]">
