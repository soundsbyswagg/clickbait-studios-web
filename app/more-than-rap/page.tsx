...
export default function MoreThanRapPage() {
  return (
    <div className="container py-12 md:py-20">
      ...
      <Link href={inquiryRoutes.moreThanRap} className="mt-8 inline-flex min-h-11 items-center rounded-md bg-accent px-6 font-semibold text-accent-foreground"><PageText id="program.cta" /></Link>
    </div>
  );
}
